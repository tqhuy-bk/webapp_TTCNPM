...
<?php 
 ...
 <?php 
   if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
      ...
      $check_update_password= $customer->update_password_customer($_POST, $id);
   }
?>
 <style>
    .container{
        ...
        <div class="container" style="background:#dbdee0;width:100%;margin:auto;min-height:500px;">
            <aside class=" gKGcfW">
                ...
                <ul class="uSLJP">
                     ...
                     <li>
                        <a class="is-active" href="changePassword.php">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path></svg>
            ...
            <div class="edAZXd">
                <h3 class="jZJmua"> Thay đổi mật khẩu</h3>
                <div class="irgDVD">
                    <form action="" method="post"> 
                        <div class="form-control ">
                            <label class="input-label">Mật khẩu cũ:</label>
                            <div><input type="password" name="passwordOld" maxlength="128" class="bYlDgr" placeholder="Hãy nhập mật khẩu cũ..." ></div>
                        </div>
                        <div class="form-control ">
                            <label class="input-label">Mật khẩu mới:</label>
                            <div><input type="password" name="passwordNew" maxlength="128" class="bYlDgr" placeholder="Hãy nhập mật khẩu mới..." ></div>
                        </div>
                        <?php  

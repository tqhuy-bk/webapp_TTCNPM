...
<div class="main">
    <div class="content">
      <div class="container" style="background:#dbdee0;width:100%;margin:auto;min-height:500px;">
            <aside class=" gKGcfW">
                <div class="hBHoW"><img src="https://salt.tikicdn.com/desktop/img/avatar.png"><div class="info">Xin chào <strong> <?php echo $result['customerName'] ?></strong></div></div>
                <ul class="uSLJP">
                     <li>
                        <a  href="profile.php">
            ...
            <div class="edAZXd">
                <h3 class="jZJmua">Nạp tiền vào tài khoản</h3>
                <div class="irgDVD">
                    <form action="" method="post">
                        <div class="form-control">
                            <label class="input-label">Mã thẻ</label>
                            <div><input type="text" name="cardcode" maxlength="128" class="bYlDgr"  placeholder="Nhập mã thẻ..."></div>
                        </div>
                        <div class="form-control">
                            <label class="input-label">Mật khẩu thẻ</label><div><input type="tel" name="cardPass" placeholder="Nhập mật khẩu thẻ..." class="bYlDgr"></div>
                        </div>
                        <div class="form-control">
                            <label class="input-label">Số tiền cần nạp</label>
                            <input type="text" name="amount" class="bYlDgr" placeholder="Nhập số tiền...">
                        </div>
                        <div class="form-control">
                            <label class="input-label">&nbsp;</label>
                            <button type="submit" name= "submit" class="btn-submit">Nạp tiền</button>
                        </div>
                         <?php 
                              if(isset($check_draw)){

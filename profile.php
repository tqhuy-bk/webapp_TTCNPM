                ...
                <div class="irgDVD">
                    <form action="" method="post">
                        ...
                        <div class="form-control ">
                            ...
                            <div><input type="text" name="customerName" maxlength="128" class="bYlDgr" value="<?php echo $result['customerName'] ?>"></div>
                        </div>
                        <div class="form-control ">
                            <label class="input-label">Số điện thoại</label><div><input type="tel" name="customerPhone"placeholder="Hãy nhập SĐT để trải nghiệm tốt hơn" class="bYlDgr" value="<?php echo $result['customerPhone'] ?>"></div>
                        </div>
                        <div class="form-control">
